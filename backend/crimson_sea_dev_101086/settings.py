"""
Django settings for crimson_sea_dev_101086 project.
...
ROOT_URLCONF = 'crimson_sea_dev_101086.urls'
...
WSGI_APPLICATION = 'crimson_sea_dev_101086.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crimson_sea_dev_101086 API",
    "DESCRIPTION": "API documentation for crimson_sea_dev_101086 App",
    "VERSION": "v1",
}
